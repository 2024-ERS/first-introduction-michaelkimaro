...
#browse your datafile to be used using url
...
m1b<-lm(specrich~graztreat,data=dat)
anova(m1b,test="F") # same result as above
...
tukey_cld # means with same letter are not significantly different

#add tukey_cld letters to the plot
